			...
			<table class="table">
				...
				<tr>
					<td colspan="4" class="text-right">
						...
						<input type="button" class="btn-xs btn-info" @click="del()" value="삭제" ref="delBtn">
				...
				<tr v-show="isShow">
					<td colspan="4" class="text-right">
						...
						<input type="button" value="삭제" class="btn-sm btn-danger" ref="deleteBtn" @click="boardDelete()">
					</td>
				</tr>
			</table>
		</div>
