...
public class DataBoardRestController {
	...
	public String databoard_insert(DataBoardVO vo , HttpServletRequest request) {
		/*
		 * System.out.println(vo.getName()); System.out.println(vo.getSubject());
		 * System.out.println(vo.getContent()); System.out.println(vo.getPwd());
		 * System.out.println(vo.getFiles().size()); if(vo.getFiles().size()>0) { for
		 * (int i = 0; i < vo.getFiles().size(); i++) {
	...
	public String databoard_update_ok(DataBoardVO vo , HttpServletRequest request) throws Exception {
